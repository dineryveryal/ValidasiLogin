...
public class RegisterActivity extends AppCompatActivity {
    ...
    EditText editUsername, editPassword, editEmail, editNamaLegkap, editAsalSekolah, editAlamat;
    Button btnSimpan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editNamaLegkap = findViewById(R.id.editNamaLengkap);
    ...
    boolean isValidation() {
        if (editUsername.getText().toString().equals("") ||
                ...
                editNamaLegkap.getText().toString().equals("") ||
    ...
    void simpanFileData() {
        String isifile = editUsername.getText().toString() + ";" +
                ...
                editNamaLegkap.getText().toString() + ";" +
        ...
        Toast.makeText(this, "Regiser Berhasil",
